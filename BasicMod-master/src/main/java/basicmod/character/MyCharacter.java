...
import basicmod.relics.GoodEating;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("MagicMan"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(RandomSpeaking.ID);
        retVal.add(Exactly.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(GoodEating.ID);
        retVal.add(MagicDice.ID);
